...
/// </summary>
class ASPOSE_PDF_SHARED_API SignatureField FINAL : public Aspose::Pdf::Forms::Field
{
...
public:
    ...
    /// </param>
    void Sign(System::SharedPtr<Aspose::Pdf::Forms::Signature> signature, System::SharedPtr<System::IO::Stream> pfx, System::String pass);
    ...
    void Sign(System::SharedPtr<Aspose::Pdf::Forms::Signature> signature);
    /// <summary>
    ...
    System::SharedPtr<System::IO::Stream> ExtractImage(System::SharedPtr<System::Drawing::Imaging::ImageFormat> format);
    /// <summary>
