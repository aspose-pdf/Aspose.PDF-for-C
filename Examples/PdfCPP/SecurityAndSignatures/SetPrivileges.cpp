...
void SetDocumentPriveleges()
{
	...
	auto doc = MakeObject<Document>(u"..\\Data\\SecurityAndSignatures\\input.pdf");
	...
	doc->Encrypt(u"user", u"owner", privilege, CryptoAlgorithm::AESx128, false);
	doc->Save(u"..\\Data\\SecurityAndSignatures\\SetPrivelegesWay1_out.pdf");
	...
	doc->Encrypt(u"user", u"owner", privilege2, CryptoAlgorithm::AESx128, false);
	doc->Save(u"..\\Data\\SecurityAndSignatures\\SetPrivelegesWay2_out.pdf");
	...
	doc->Encrypt(u"user", u"owner", privilege3, CryptoAlgorithm::AESx128, false);
	doc->Save(u"..\\Data\\SecurityAndSignatures\\SetPrivelegesWay3_out.pdf");
	...
	doc->Encrypt(u"user", u"owner", privilege4, CryptoAlgorithm::AESx128, false);
	doc->Save(u"..\\Data\\SecurityAndSignatures\\SetPrivelegesWay4_out.pdf");
	// ExEnd:Priveleges
}