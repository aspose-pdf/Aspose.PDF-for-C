...
template<>
struct EnumMetaInfo<Aspose::Pdf::Engine::Presentation::Graphics::HatchStyle>
{
    static const ASPOSE_PDF_SHARED_API std::array<std::pair<Aspose::Pdf::Engine::Presentation::Graphics::HatchStyle, const char_t*>, 56>& values();
};
