...
class ASPOSE_PDF_SHARED_API Color FINAL : public System::Object
{
    ...
    friend ASPOSE_PDF_SHARED_API bool operator ==(System::SharedPtr<Color> const &x, System::SharedPtr<Color> const &y);
    friend ASPOSE_PDF_SHARED_API bool operator !=(System::SharedPtr<Color> const &x, System::SharedPtr<Color> const &y);
...
public:
    ...
    /// Color object with each component value in [0..255] range.
    /// </returns>
    static System::SharedPtr<Color> FromArgb(int32_t a, int32_t r, int32_t g, int32_t b);
    /// <summary>
    /// Gets valid pdf Color object from RGB color components.
    /// </summary>
    /// <param name="r">
...
ASPOSE_PDF_SHARED_API bool operator ==(System::SharedPtr<Color> const &x, System::SharedPtr<Color> const &y);
ASPOSE_PDF_SHARED_API bool operator !=(System::SharedPtr<Color> const &x, System::SharedPtr<Color> const &y);
