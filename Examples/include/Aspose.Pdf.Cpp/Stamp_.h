...
/// </summary>
class ASPOSE_PDF_SHARED_API Stamp : public System::Object
{
...
protected:
    ...
    virtual System::SharedPtr<Matrix> getMatrix(System::SharedPtr<Page> page);
    /// <summary>
    /// Retuns matrix which used for rotation the stamp; 
    /// </summary>
    /// <returns>Rotation matrix for the stamp.</returns>
    virtual System::SharedPtr<Matrix> getStampRotationMatrix();
    /// <summary>
