...
namespace Aspose { namespace Pdf { namespace Forms { enum class Symbology; } } }
...
/// </summary>
class ASPOSE_PDF_SHARED_API BarcodeField FINAL : public Aspose::Pdf::Forms::TextBoxField
{
...
public:
    ...
    /// </summary>
    Aspose::Pdf::Forms::Symbology get_Symbology();
    /// <summary>
