...
namespace Aspose { namespace Pdf { namespace Forms { class ExternalSignature; } } }
namespace Aspose { namespace Pdf { namespace Forms { class DocMDPSignature; } } }
namespace Aspose { namespace Pdf { class Document; } }
namespace Aspose { namespace Pdf { namespace Facades { class PdfFileSignature; } } }
namespace Aspose { namespace Pdf { namespace Forms { class PKCS1; } } }
namespace Aspose { namespace Pdf { namespace Forms { class PKCS7; } } }
namespace Aspose { namespace Pdf { namespace Forms { class PKCS7Detached; } } }
...
namespace Aspose { namespace Pdf { namespace Forms { class SignatureCustomAppearance; } } }
namespace Aspose { namespace Pdf { namespace Engine { namespace Security { namespace Impl { namespace Signatures { namespace Sanitization { class DigitalSignatureSanitization; } } } } } } }
...
/// </summary>
class ASPOSE_PDF_SHARED_API Signature : public System::Object
{
    ...
    friend class Aspose::Pdf::Forms::ExternalSignature;
...
public:
    ...
    /// </summary>
    System::SharedPtr<SignatureCustomAppearance> get_CustomAppearance();
    /// <summary>
    /// Gets/sets the custom appearance.
    /// </summary>
...
private:
    ...
    static System::SharedPtr<System::Collections::Generic::IList<System::SharedPtr<Aspose::Pdf::Engine::Security::Impl::Signatures::Sanitization::DigitalSignatureSanitization>>> _digitalSignatureSanizations;
    
    void AssertSanitization(System::SharedPtr<Aspose::Pdf::Engine::Data::IPdfDictionary> signature, System::SharedPtr<Aspose::Pdf::Engine::IPdfDocument> document);
