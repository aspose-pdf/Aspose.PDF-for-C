...
/// </summary>
class ASPOSE_PDF_SHARED_API FileAttachmentAnnotation FINAL : public Aspose::Pdf::Annotations::MarkupAnnotation
{
    ...
    friend class Aspose::Pdf::Tests::Annotations::FileAttachmentAnnotationTests;
