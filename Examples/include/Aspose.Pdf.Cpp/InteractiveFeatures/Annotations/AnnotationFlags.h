...
class AnnotationFlagsConverter : public System::Object
{
...
template<>
struct EnumMetaInfo<Aspose::Pdf::Annotations::AnnotationFlags>
{
    typedef void Flags;
    static const ASPOSE_PDF_SHARED_API std::array<std::pair<Aspose::Pdf::Annotations::AnnotationFlags, const char_t*>, 11>& values();
};
