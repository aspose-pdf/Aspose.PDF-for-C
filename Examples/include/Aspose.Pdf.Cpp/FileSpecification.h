...
/// </summary>
class ASPOSE_PDF_SHARED_API FileSpecification FINAL : public System::IDisposable
{
...
public:
    ...
    FileSpecification(System::String fileName, System::SharedPtr<Annotations::Annotation> annot);
    /// <summary>
