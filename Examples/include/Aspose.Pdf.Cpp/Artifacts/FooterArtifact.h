#ifndef _Aspose_Pdf_Artifacts_FooterArtifact_h_
#define _Aspose_Pdf_Artifacts_FooterArtifact_h_
...
protected:
    ...
    const char* DBG_class_name() const override { return "FooterArtifact"; }
...
#endif // _Aspose_Pdf_Artifacts_FooterArtifact_h_
