...
public:
    ...
    /// 
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::PdfPageEditor> editor = System::MakeObject<Aspose::Pdf::Facades::PdfPageEditor>();
    /// editor->BindPdf(L"sample.pdf");
    /// editor->set_Zoom(0.5f);
    /// </code>
    /// </example>
    /// </summary>
    float get_Zoom();
    ...
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::PdfPageEditor> editor = System::MakeObject<Aspose::Pdf::Facades::PdfPageEditor>();
    /// editor->BindPdf(L"input.pdf");
    /// editor->MovePosition(-100, 60);
    /// editor->Save(L"moved.pdf");
    /// </code>
    /// </example>
    ...
    /// System::SharedPtr<Aspose::Pdf::Facades::PdfPageEditor> editor = System::MakeObject<Aspose::Pdf::Facades::PdfPageEditor>();
    /// editor->BindPdf(L"sample.pdf");
    /// System::Console::WriteLine(System::String(L"Document has: ") + editor->GetPages());
    /// </code>
    /// </example>
    int32_t GetPages();
    /// <summary>
    ...
    /// System::SharedPtr<Aspose::Pdf::Facades::PdfPageEditor> editor = System::MakeObject<Aspose::Pdf::Facades::PdfPageEditor>();
    /// editor->BindPdf(L"sample.pdf");
    /// System::SharedPtr<PageSize> size = editor->GetPageSize(1);
    /// System::Console::WriteLine(System::String(L"Size of 1st page : ") + size->get_Width() + L" x " + size->get_Height());
    /// </code>
    /// </example>
    ...
    /// System::SharedPtr<Aspose::Pdf::Facades::PdfPageEditor> editor = System::MakeObject<Aspose::Pdf::Facades::PdfPageEditor>();
    /// editor->BindPdf(L"sample.pdf");
    /// int32_t rotation = editor->GetPageRotation(1);
    /// System::Console::WriteLine(System::String(L"Rotation of 1st page : ") + rotation + L" degrees");
    /// </code>
    /// </example>
    ...
    /// System::SharedPtr<Aspose::Pdf::Facades::PdfPageEditor> editor = System::MakeObject<Aspose::Pdf::Facades::PdfPageEditor>();
    /// editor->BindPdf(L"sample.pdf");
    /// System::Drawing::Rectangle rect = editor->GetPageBoxSize(1, L"media");
    /// </code>
    /// </example>
