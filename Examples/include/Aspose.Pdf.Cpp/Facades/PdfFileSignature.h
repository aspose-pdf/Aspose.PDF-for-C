...
public:
    ...
    /// </code>
    /// </example>
    void Sign(int32_t page, System::String SigReason, System::String SigContact, System::String SigLocation, bool visible, System::Drawing::Rectangle annotRect, System::SharedPtr<Aspose::Pdf::Forms::Signature> sig);
    /// <summary>
    /// Sign the document with the given type signature.
    /// </summary>
    /// <param name="page">The page number on which signature is made.</param>
    ...
    /// </code>
    /// </example>
    void Sign(int32_t page, bool visible, System::Drawing::Rectangle annotRect, System::SharedPtr<Aspose::Pdf::Forms::Signature> sig);
    /// <summary>
    ...
    /// </code>
    /// </example>
    void Sign(System::String SigName, System::String SigReason, System::String SigContact, System::String SigLocation, System::SharedPtr<Aspose::Pdf::Forms::Signature> sig);
    /// <summary>
    /// Sign the document with the given type signature which is placed in already presented signature field.
    ...
    /// </code>
    /// </example>
    void Sign(int32_t page, System::String SigName, System::String SigReason, System::String SigContact, System::String SigLocation, bool visible, System::Drawing::Rectangle annotRect, System::SharedPtr<Aspose::Pdf::Forms::Signature> sig);
    /// <summary>
    /// Sign the document with the given type signature which is placed in already presented signature field.
    /// Before signing signature field must be empty, i.e. field must not contain signature dictionary.
    /// Thus pdf document already has signature field, you should not supply the place to stamp the signature,
    ...
    /// </code>
    /// </example>
    void Sign(System::String SigName, System::SharedPtr<Aspose::Pdf::Forms::Signature> sig);
    /// <summary>
    ...
    void Certify(int32_t page, System::String SigReason, System::String SigContact, System::String SigLocation, bool visible, System::Drawing::Rectangle annotRect, System::SharedPtr<Aspose::Pdf::Forms::DocMDPSignature> docMdpSignature);
    /// <summary>
