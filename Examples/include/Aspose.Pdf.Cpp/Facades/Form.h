...
public:
    ...
    /// 
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>();
    /// form->set_SrcFileName(L"file.pdf");
    /// </code>
    /// </example>
    /// </summary>
    ...
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>();
    /// form->set_DestFileName(L"file.pdf");
    /// </code>
    /// </example>
    ...
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>();
    /// form->set_SrcStream(System::MakeObject<System::IO::FileStream>(L"source.pdf", System::IO::FileMode::Open, System::IO::FileAccess::Read));
    /// </code>
    /// </example>
    /// </summary>
    ...
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>();
    /// form->set_DestStream(System::MakeObject<System::IO::FileStream>(L"file.pdf", System::IO::FileMode::Open, System::IO::FileAccess::Read));
    /// </code>
    /// </example>
    ...
    /// 
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>(L"PdfForm.pdf");
    /// System::ArrayPtr<System::String> fields = form->get_FieldNames();
    /// for (int i_ = 0; i_<fields->Count(); ++i_)
    /// {
    ///     System::String field = fields[i_];
    ...
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>(L"PdfForm.pdf");
    /// System::ArrayPtr<System::String> submits = form->get_FormSubmitButtonNames();
    /// for (int i_ = 0; i_<submits->Count(); ++i_)
    /// {
    ///     System::String btn = submits[i_];
    ///     System::Console::WriteLine(btn);
    /// }
    /// </code>
    /// </example>
    ...
    /// 
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>(L"form.pdf");
    /// System::SharedPtr<Aspose::Pdf::Facades::FormFieldFacade> field = form->GetFieldFacade(L"field1");
    /// System::Console::WriteLine(System::String(L"Color of field border: ") + field->get_BorderColor());
    /// </code>
    /// </example>
    /// </summary>
    ...
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>(
    ///     System::MakeObject<System::IO::FileStream>(L"InFile.pdf", System::IO::FileMode::Open, System::IO::FileAccess::Read)
    ///   , System::MakeObject<System::IO::FileStream>(L"OutFile.pdf", System::IO::FileMode::Create, System::IO::FileAccess::Write));
    /// </code>
    /// </example>
    ...
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>(L"input.pdf", L"output.pdf");
    /// const System::ArrayPtr<System::String>& array_ = form->get_FieldNames();
    /// for (int i_ = 0; i_<array_->Count(); ++i_)
    /// {
    ///     System::String fieldName = array_[i_];
    ///     if (fieldName.EndsWith(L"ListBoxField"))
    ///     {
    ///         System::Console::WriteLine(System::String(L"Full name is: ") + fieldName);
    ///     }
    /// }
    /// </code>
    /// </example>
    ...
    /// {
    ///     System::String fieldName = array_[i_];
    ///     if (fieldName.EndsWith(L"CheckBoxField"))
    ///     {
    ///         System::Console::WriteLine(System::String(L"Full name is: ") + fieldName);
    ///     }
    /// }
    ...
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>(L"PdfForm.pdf");
    /// System::Console::WriteLine(form->GetButtonOptionCurrentValue(L"btnField"));
    /// </code>
    /// </example>
    ...
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>(L"PdfForm.pdf");
    /// System::SharedPtr<System::Collections::Generic::Dictionary<System::String, System::String>> values = form->GetButtonOptionValues(L"Color");
    /// System::Console::WriteLine(System::ObjectExt::ToString(values->idx_get(L"White")));
    /// System::Console::WriteLine(System::ObjectExt::ToString(values->idx_get(L"Black")));
    /// </code>
    /// </example>
    ...
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>(L"PdfForm.pdf");
    /// System::Console::WriteLine(System::String(L"Field value = ") + form->GetField(L"Field1"));
    /// </code>
    /// </example>
    ...
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>(L"PdfForm.pdf");
    /// System::Console::WriteLine(System::String(L"Full field name is : ") + form->GetFullFieldName(L"textField"));
    /// </code>
    /// </example>
    ...
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>(L"PdfForm.pdf");
    /// System::Console::WriteLine(form->GetFieldLimit(L"textfieldBox"));
    /// </code>
    /// </example>
    ...
    /// 
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>(L"PdfForm.pdf", L"PdfForm_Changed.pdf");
    /// form->FillField(L"textField", System::String(L"new value"));
    /// form->Save();
    /// </code>
    /// </example>
    void Save();
    ...
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>(L"PdfForm.pdf");
    /// form->FillBarcodeField(L"textField", L"42207252");
    /// </code>
    /// </example>
    ...
    /// 
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>(L"PdfForm.pdf", L"PdfForm_imported.pdf");
    /// form->ImportFdf(System::MakeObject<System::IO::FileStream>(L"data.fdf", System::IO::FileMode::Open, System::IO::FileAccess::Read));
    /// form->Save();
    /// </code>
    /// </example>
    ...
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>(L"PdfForm.pdf");
    /// System::SharedPtr<System::IO::Stream> stream = System::MakeObject<System::IO::FileStream>(L"export.fdf", System::IO::FileMode::Create, System::IO::FileAccess::Write);
    ...
    /// 
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>(L"PdfForm.pdf", L"Form_Imported.pdf");
    /// System::SharedPtr<System::IO::FileStream> fs = System::MakeObject<System::IO::FileStream>(TestSettings::GetInputFile(L"import.xml"), System::IO::FileMode::Open, System::IO::FileAccess::Read);
    /// form->ImportXml(fs);
    /// form->Save();
    /// </code>
    /// </example>
    ...
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>(L"PdfForm.pdf");
    /// System::SharedPtr<System::IO::FileStream> fs = System::MakeObject<System::IO::FileStream>(L"export.xml", System::IO::FileMode::Create, System::IO::FileAccess::Write);
    /// form->ExportXml(fs);
    /// fs->Close();
    /// </code>
    /// </example>
    ...
    /// 
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>(L"PdfForm.pdf", L"Form_ImportXfdf.pdf");
    /// System::SharedPtr<System::IO::Stream> fs = System::MakeObject<System::IO::FileStream>(L"export_old.xfdf", System::IO::FileMode::Open, System::IO::FileAccess::Read);
    /// form->ImportXfdf(fs);
    /// fs->Close();
    /// form->Save();
    /// </code>
    ...
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>(L"PdfForm.pdf");
    /// System::SharedPtr<System::IO::FileStream> fs = System::MakeObject<System::IO::FileStream>(L"export.xfdf", System::IO::FileMode::Create, System::IO::FileAccess::Write);
    /// form->ExportXfdf(fs);
    /// fs->Close();
    /// </code>
    /// </example>
    ...
    /// 
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>(L"PdfForm.pdf", L"Form_Updated.pdf");
    /// form->FillField(L"ListBox1", System::MakeArray<System::String>({ L"Three", L"One"}));
    /// form->Save();
    /// </code>
    /// </example>
    ...
    /// 
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>(L"PdfForm.pdf", L"PdfFormUpdated.pdf");
    /// form->RenameField(L"field", L"field1");
    /// form->Save();
    /// </code>
    /// </example>
    ...
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>(L"PdfForm.pdf");
    /// System::Console::WriteLine(form->GetRichText(L"txtDescriptionRTF"));
    /// </code>
    /// </example>
    ...
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>(L"PdfForm.pdf");
    /// System::Console::WriteLine((form->GetSubmitFlags(L"btnSubmit") | Aspose::Pdf::Facades::SubmitFormFlag::Xfdf) != static_cast<Facades::SubmitFormFlag>(0) ? System::String(L" XFDF") : System::String(L" "));
    /// System::Console::WriteLine((form->GetSubmitFlags(L"btnSubmit") | Aspose::Pdf::Facades::SubmitFormFlag::Fdf) != static_cast<Facades::SubmitFormFlag>(0) ? System::String(L" FDF") : System::String(L" "));
    /// System::Console::WriteLine((form->GetSubmitFlags(L"btnSubmit") | Aspose::Pdf::Facades::SubmitFormFlag::Pdf) != static_cast<Facades::SubmitFormFlag>(0) ? System::String(L" PDF") : System::String(L" "));
    /// </code>
    /// </example>
    ...
    /// 
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>(System::MakeObject<System::IO::FileStream>(L"PdfForm.pdf", System::IO::FileMode::Open, System::IO::FileAccess::Read));
    /// </code>
    /// </example>
    ...
    /// 
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>(L"PdfForm.pdf", L"PdfForm_Updated.pdf");
    /// </code>
    /// </example>
    ...
    /// 
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>(System::MakeObject<System::IO::FileStream>(L"PdfForm.pdf", System::IO::FileMode::Open, System::IO::FileAccess::Read), L"PdfForm_Updated.pdf");
    /// </code>
    /// </example>
    ...
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>(L"PdfForm.pdf");
    /// if (form->GetFieldType(L"textField") == Aspose::Pdf::Facades::FieldType::Text)
    /// {
    ///     System::Console::WriteLine(L"Type of field is text");
    /// }
    /// </code>
    /// </example>
    ...
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>(L"PdfForm.pdf");
    /// if (form->GetFieldFlag(L"textField") == Aspose::Pdf::Facades::PropertyFlag::ReadOnly)
    /// {
    ///     System::Console::WriteLine(L"Field is read-only");
    /// }
    /// </code>
    /// </example>
    ...
    /// 
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>(L"PdfForm.pdf", L"PdfForm_filled.pdf");
    /// form->FillImageField(L"fieldName", System::String(L"file.jpg"));
    /// form->Save();
    /// </code>
    /// </example>
    ...
    /// <code>
    /// System::SharedPtr<Aspose::Pdf::Facades::Form> form = System::MakeObject<Aspose::Pdf::Facades::Form>(L"PdfForm.pdf", L"PdfForm_filled.pdf");
    /// form->FillImageField(L"fieldName", System::MakeObject<System::IO::FileStream>(L"file.jpg", System::IO::FileMode::Open, System::IO::FileAccess::Read));
    /// </code>
    /// </example>
...
private:
    ...
    /// <summary>
    /// Creates appearance operators set according to the field properties (default appearance etc)
    /// </summary>
    /// <param name="field">Field which appearance will be created.</param>
    /// <param name="displayValue">Value of the field</param>
    /// <returns></returns>
