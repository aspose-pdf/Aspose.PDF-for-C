...
namespace Aspose { namespace Pdf { namespace Tests { namespace Facades { class PdfFileEditorTests; } } } }
...
public:
    ...
    /// </summary>
    int32_t get_ConcatenationPacketSize();
    /// <summary>
    /// Number of documents concatenated before new incremental update was made during concatenation when UseDiskBuffer is set to true.
    /// </summary>
...
private:
    ...
    void FixOutline(System::SharedPtr<OutlineItemCollection> item);
